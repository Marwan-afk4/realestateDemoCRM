@extends('layouts.app')
@section('title', __('Create Administrative Data Field'))
@section('content')
<div class="container-fluid">
    <h1 class="mb-3">{{ __('Create Administrative Data Field') }}</h1>
    <div class='main-card mb-3 card'>
        <div class='card-body'>
            <form action="{{ route('administrative-data.store') }}" method="POST">
                @csrf
                <div class="row">
