@extends('layouts.app')
@section('title', __('Edit Residential Data Field'))
@section('content')
<div class="container-fluid">
    <h1 class="mb-3">{{ __('Edit Residential Data Field') }}</h1>
    <div class='main-card mb-3 card'>
        <div class='card-body'>
            <form action="{{ route('residential-data.update', $field) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
